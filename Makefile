...
APPGEN		?= $(SDK_TOOLS)/gen_appbin.py
...
$1/%.o: %.cpp
	$(vecho) "CPP $$<"
	$(Q) $(CPP) $(INCDIR) $(MODULE_INCDIR) $(EXTRA_INCDIR) $(SDK_INCDIR) $(CFLAGS)  -c $$< -o $$@
...
FastLED:
	$(Q) make -C FastLED USE_OPENSDK=$(USE_OPENSDK)

#$(APP_AR): libesphttpd FastLED $(OBJ)
