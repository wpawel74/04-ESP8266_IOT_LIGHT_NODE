...
static int16_t ICACHE_FLASH_ATTR BMP180_readRegister16(uint8_t reg){
	i2c_master_start();
...
#ifdef BMP180_DEBUG
		//os_printf("slave not ack..\n return \n");
		os_printf("BMP180_readRegister16: i2c_writeByte(reg) slave not ack..\r\nreturn\r\n");
#endif
		i2c_master_stop();
		return(0);
	}
...
#ifdef BMP180_DEBUG
		//os_printf("slave not ack..\n return \n");
		os_printf("BMP180_readRegister16: i2c_writeByte(0xEF) slave not ack..\r\nreturn\r\n");
#endif
		i2c_master_stop();
		return(0);
	}
...
#ifdef BMP180_DEBUG
		//os_printf("slave not ack..\n return \n");
		os_printf("BMP180_readExRegister16: i2c_writeByte(0xEE) slave not ack..\r\nreturn\r\n");
#endif
		i2c_master_stop();
		return(0);
	}
...
#ifdef BMP180_DEBUG
		//os_printf("slave not ack..\n return \n");
		os_printf("BMP180_readExRegister16: i2c_writeByte(reg) slave not ack..\r\nreturn\r\n");
#endif
		i2c_master_stop();
		return(0);
	}
...
#ifdef BMP180_DEBUG
		//os_printf("slave not ack..\n return \n");
		os_printf("BMP180_readExRegister16: i2c_writeByte(0xEF) slave not ack..\r\nreturn\r\n");
#endif
		i2c_master_stop();
		return(0);
	}
...
#ifdef BMP180_DEBUG
		//os_printf("slave not ack..\n return \n");
		os_printf("BMP180_readRawValue: i2c_writeByte(0xEE) slave not ack..\r\nreturn\r\n");
#endif
		i2c_master_stop();
		return(0);
	}
...
#ifdef BMP180_DEBUG
		//os_printf("slave not ack..\n return \n");
		os_printf("BMP180_readRawValue: i2c_writeByte(0xF4) slave not ack..\r\nreturn\r\n");
#endif
		i2c_master_stop();
		return(0);
	}
...
#ifdef BMP180_DEBUG
		//os_printf("slave not ack..\n return \n");
		os_printf("BMP180_readRawValue: i2c_writeByte(cmd) slave not ack..\r\nreturn\r\n");
#endif
		i2c_master_stop();
		return(0);
	}
...
#ifdef BMP180_DEBUG
		//os_printf("slave not ack..\n return \n");
		os_printf("BMP180_readExRawValue: i2c_writeByte(0xEE) slave not ack..\r\nreturn\r\n");
#endif
		i2c_master_stop();
		return(0);
	}
...
#ifdef BMP180_DEBUG
		//os_printf("slave not ack..\n return \n");
		os_printf("BMP180_readExRawValue: i2c_writeByte(0xF4) slave not ack..\r\nreturn\r\n");
#endif
		i2c_master_stop();
		return(0);
	}
...
#ifdef BMP180_DEBUG
		//os_printf("slave not ack..\n return \n");
		os_printf("BMP180_readExRawValue: i2c_writeByte(cmd) slave not ack..\r\nreturn\r\n");
#endif
		i2c_master_stop();
		return(0);
	}
