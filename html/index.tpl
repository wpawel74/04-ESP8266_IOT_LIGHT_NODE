<html>
	<head>
		<title>ESP8266 Comfort Module</title>
	...
	<body>
		<div id="main"><h1>Main</h1>
			...
			<ul>
				...
				<li>Sensor readings: <a href="control/dht22.tpl">DHT22</a> or <a href="control/ds18b20.tpl">DS18B20</a> alternative <a href="control/bmp180.tpl">BMP180</a>.</li>
